  ...
  return (
    <>
      <DefaultSeo
        ...
        description="Free Law Project is the leading nonprofit using technology and data to make the legal ecosystem more equitable and competitive. Creators of CourtListener, RECAP, and Bots.law."
        additionalLinkTags={[
          // Images
          {
            rel: 'icon',
