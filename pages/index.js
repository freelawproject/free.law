    ...
    <>
      <Layout allPosts={allPostsData} home={true}>
        <main>
          <Head>
            <title>
              Free Law Project — A non-profit making the legal ecosystem more equitable and
              competitive.
            </title>
          </Head>
            ...
            <div className="flex flex-wrap py-16">
              ...
              >
                <GridListItem heading="Opinions Database" bg="bg-transparent">
                  ...
                  <p>
                    We gather more opinions from state and federal courts every day, and hope to
                    soon host the first open and complete collection of American case&nbsp;law.
                  </p>
                </GridListItem>
                  ...
                  <p>
                    ...
                    <Link href="https://www.courtlistener.com/audio/">
                      <a className="underline">
                        the biggest open collection of oral argument audio
                      </a>
                    </Link>{' '}
                    in the world.
                  </p>
          ...
          <MainColumn>
            ...
            <section className="w-full py-16" id="tools">
              ...
              <div className="w-full pt-3 pb-5 text-gray-700">
                <H3>
                  To spur innovation in the legal ecosystem, all of our work is open source and
                  freely available. These tools give organizations and researchers a launchpad for
                  their&nbsp;innovation.{' '}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 items-stretch gap-8 w-full">
                ...
                >
                  <p>
                    Eyecite uses our database of thousands of reporters to find even the most
                    esoteric legal citations in any block of&nbsp;text.
                  </p>
                </GridListItem>
              </div>
            </section>
          ...
          <MainFullBleedColumn bgClasses="bg-purple-800">
            <div className="pt-16 pb-24  text-gray-100" id="datasets">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
                ...
                >
                  <p>
                    Our database of reporters has information about more than 700 reporters, with
                    more than 1,400 name variations. Build citators, normalize citations,
                    and&nbsp;more.
                  </p>
                </GridListItem>
                <GridListItem
            ...
            <section className="w-full py-16" id="testimonials">
              <div className="text-center">
                ...
                <div className="w-3/4 pt-5 m-auto">
                  <H3>
                    When you need legal data, we can help. We work with journalists, researchers,
                    and organizations large and small to get the data they&nbsp;need.
                  </H3>
                </div>
              </div>
