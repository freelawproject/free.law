      ...
      <Layout allPosts={allPostsData} home={false}>
          ...
          <PostColumn>
              <div className="pt-10 mt-10 text-center border border-gray-500">
                <H1>404 U.S. <span className="tracking-tight">____</span>, Page Not Found</H1>
                <p>Sorry. The requested item could not be found.</p>
                <p>Sometimes it's possible to find things in the <Link href="/blog/"><a>Blog Archive</a></Link>.</p>
              </div>
          </PostColumn>
      </Layout>
    )
