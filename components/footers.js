...
export function Footer({recentPost}){
  return (
    <MainFullBleedColumn bgClasses="border-t border-gray-300 mt-16">
      <section className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-8 md:gap-10 lg:gap-12 w-full py-8 justify-start" id="footer">
        ...
        <div className="w-full">
          <div className="pb-3">
            ...
            <FooterLink href="/team/">Board of Directors</FooterLink>
            <FooterLink href="/non-profit-documents/">Non-Profit Documents</FooterLink>
            <FooterLink href="/hiring/">Hiring</FooterLink>
            <FooterLink href="/press-assets/">Press <span className="hidden lg:inline">Logos and </span>Assets</FooterLink>
            <FooterLink href="/vulnerability-disclosure-policy/">Vulnerability Disclosure Policy</FooterLink>
    ...
    <MainFullBleedColumn bgClasses="border-t border-gray-300">
      <div className="py-12 flex flex-wrap justify-between" id="colophon">
        <div className="w-full sm:w-2/5 text-gray-400">
          <p className="text-sm">© {(new Date().getFullYear())} Free Law Project. Content licensed under a Creative Commons BY-ND international 4.0, license, except where indicated.</p>
        </div>
