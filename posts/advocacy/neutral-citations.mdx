...
<p className="lead">Neutral citations are standard, court-assigned references for court opinions that remain the same, regardless of the publisher. This makes them universally accessible across different legal databases and publications.</p>
