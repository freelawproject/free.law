...
<p className="lead">These instructions show you how to run our docker image to
  gather and share API results from Harvard's Caselaw Access Project API.</p>
...
1. <a href="https://case.law/user/register/" target="_blank" rel="noreferrer">Create
  an account with Harvard and get an API key</a>.
