...
In research papers, these data sets may be cited according to [our citation guidance][cite].
...
<p className="lead">Courtlistener has one of the most [comprehensive collections][clc] of American legal jurisprudence on the Internet.</p>
...
Our data is sourced from a wide range of institutions and organizations, including Resource.org, the [Supreme Court Database][scdb], Columbia, Harvard, and the Law Library of Congress, among others. We also [partner with courts][part] to enable direct publishing of case law.
...
<p className="lead">The RECAP Archive is the biggest open collection of federal court data on the Internet.</p>
...
The data in RECAP is collected from many different sources. A significant source is more than 30,000 people that have installed the [RECAP Extension][r] in their browser. As they use PACER, the extension sends copies of their purchases to RECAP.
...
We host a [free API that organizations use to gather content from PACER][fetch]. We also scrape PACER documents, crawl federal district court RSS feeds, and scrape metadata for District and Bankruptcy cases.
...
<p className="lead">For the benefit of researchers, practitioners, and the public we are proud to host a comprehensive structured database of judges and their financial interests.</p>
...
In 2023, ProPublica utilized this dataset for an investigation into the Supreme Court, which led to their winning the Pulitzer Prize. The Pulitzer committee [praised][propublica] ProPublica's "groundbreaking and ambitious reporting that pierced the thick wall of secrecy surrounding the Supreme Court." 
...
<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
    ...
    <PurpleButton href="https://wiki.free.law/c/courtlistener/help/api/bulk-data">Download Bulk Data</PurpleButton>
</div>
...
<div className="text-center">
    <PurpleButton href="https://wiki.free.law/c/courtlistener/help/api" size="lg">Check Out the Data</PurpleButton>
</div>

[alerts]: https://www.courtlistener.com/help/alerts/
[apis]: https://wiki.free.law/c/courtlistener/help/api/rest/
...
[fetch]: https://wiki.free.law/c/courtlistener/help/api/rest/v4/recap#pacer-fetch
[cite]: /citing-flp/
