...
<RightImage imgProps={{
   "src": "/images/fjc-logo.png",
   "alt": "FJC Logo"
}} height="h-24"/>


<p className="lead">This page is where we keep useful information and notes for people that are using the <a href="https://www.fjc.gov/research/idb">Integrated Database</a> provided by the Federal Judicial Center.</p>
...
<a href="/xlsx/fjc/integrated-database/office-codes.xlsx"
   className="btn btn-lg btn-primary">Download the office codes</a>
...
<a href="/xlsx/fjc/integrated-database/cv88on-field-lengths.xlsx"
   className="btn btn-lg btn-primary">Download the civil field info</a>
...
<a href="/xlsx/fjc/integrated-database/cr96on-field-lengths.xlsx"
   className="btn btn-lg btn-primary">Download the criminal field info</a>  
...
<div className="text-center">
    <img src="/images/judge-specific-data.png"
...
[031995]: /pdf/judicial-conference-proceedings/1995-03.pdf 
[032003]: /pdf/judicial-conference-proceedings/2003-03.pdf
