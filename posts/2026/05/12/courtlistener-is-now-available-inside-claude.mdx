---
title: "CourtListener Is Now Available Inside Claude and Other AI Assistants"
date: "2026-05-12"
tags:
  - "Feature Launch"
  - "CourtListener"
...
<p className="lead">CourtListener is now available inside Claude as a new MCP Connector. Giving Claude and other AI agents native access to the full power of CourtListener including case law, parenthetical case holdings, PACER data, citation analysis, oral argument transcripts, judge data, search, alerts, and more.</p>

This is real primary legal data, not summaries, not scraped text, and not reconstructed from training data. It is grounded access to primary sources at the moment people need them most, inside the AI tools they are already using.

The MCP is a free new tool that uses your API access on the CourtListener platform to bring unparalleled legal research to your fingertips. Need research on a topic? Ask Claude for a memo. Need citations verified? No problem. Want to automatically identify and analyze cases or filings in bulk? Put the AI agent to work. Read on for details. This is a big one.
...
But access to data is only half the problem. Increasingly, people start their legal questions with AI. That presents a real risk because AI tools often answer legal questions without grounded access to primary sources, producing confident responses built on hallucinations rather than real case law. The same barrier we have spent years dismantling is reappearing in a new form. People can reach the law, but they still cannot trust what they are being told about it. This integration directly addresses that.

## What we built

MCP, or Model Context Protocol, is an open standard that lets AI models connect to external data sources and tools. Think of it as a direct line between Claude and the systems that hold real-world information — in this case, CourtListener's legal database.
...
2. Go to **Settings > Connectors > Browse**.
...
<p className="centered-row">
  <PurpleButton href="https://claude.ai/settings/connectors" size="lg">Connect CourtListener to Claude</PurpleButton>
</p>
...
**On privacy.** Court documents contain personal information: names, addresses, financial details, and medical history. The fact that this information is public record does not mean it should be handled carelessly. Be thoughtful about what you retrieve and what you upload. When working with court documents inside Claude, avoid submitting filings or records that contain sensitive personal information unless it is strictly necessary for your query.
...
**On infrastructure.** Every query through this MCP hits CourtListener's live systems. Please avoid bulk or repetitive requests that could degrade access for other users. CourtListener is a shared public resource.
...
<p className="centered-row">
  <PurpleButton href="https://wiki.courtlistener.com" size="lg">Learn More on our Wiki</PurpleButton>
</p>
...
[wiki]: https://wiki.courtlistener.com
