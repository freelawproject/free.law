...
On the technical side of things, we accomplished a number of major goals:
 ...
 - We launched [@recap.email][re], our system for automatically adding ECF notifications to RECAP and firm CMS's. This is a powerful new way to contribute documents to the RECAP Archive that we'll be promoting in the new year.
 ...
 - We worked with Pre/Dicta to add thousands of judges in [Texas, New York][judge-db2], and [California][judge-db1] to our database.
...
We have many goals for 2023:
 ...
 - We will seek a partnership with a court to build an open source docketing system. This first-of-its-kind system will be open, searchable, and usable by default. We tire of for-profit companies putting paywalls in front of public information.
