...
<p className="lead">Free Law Project is the leading non-profit using advocacy, technology, and data to improve the legal system. Today we're asking for your support so that 2025 can be the best year ever for RECAP, CourtListener, and all we do.</p>


Read on to learn more about what we've been up to or click below to give us your support. Thank you.

<RedButton href="" size="lg" extraClasses="inline-flex"><HeartIcon className="flex-shrink-0 h-5 w-5" aria-hidden="true"/>&nbsp;Donate Now</RedButton>


## FLP's Year in Review

When I write this letter each year, I have the immense pleasure of looking back at all of our accomplishments and tallying them up. Without fail, I'm astounded at how the day-to-day work snowballs into a long list of successes. Our mantra around here is to play the long game, and in 2024, a number of our big bets either paid off or were set into motion. 
...
7. **Conferences**
    ...
    We presented at numerous conferences including NICAR (three presentations!), LitCon, AALL, and eCourts.
...
1. **Case Law**
    ...
    Our case law is widely used, but it's imperfect. We've made huge strides building this data set over the past 15 years, and 2025 is the year to finish it. 

    We'll do that by launching a scanning initiative and focusing on fixing data quality and display issues.

2. **AI**

    Artificial intelligence is a huge deal in the legal sector, and we will be working hard to build open and responsible AI solutions. This will mean a citator, summarization, categorization, semantic search, and enhancements to our oral argument audio files.
...
4. **CourtListener will look good!**
    ...
    Until now, we haven't had a designer for CourtListener, and, well, we know it shows. Our new branding was the first step. Now it's time to build a new website that is faster and easier to use.

5. **Search**

    Search is at the core of CourtListener, and we'll be making it a lot better in the coming year. We'll add query defaults, search history, auto-complete, better relevancy, and a bunch more.

Whew, that is a lot, and that's not even everything. Our full plan lists about 30 features we will launch, big and small. It's going to be an incredible year. 
...
If the above does not impress you yet, I will close this letter with a few statistics that highlight the scope of our work. 
...
But just how big is RECAP?

`151 million` — the number of pages we have in RECAP
...
RECAP can circle the Earth and is more than one and a half times taller than Everest.