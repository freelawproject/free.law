...
<p className="lead">The RECAP extensions are hosted by Free Law Project, a non-profit that is dedicated to opening legal data. Once per year we ask for your support so we can continue hosting and enhancing the RECAP extensions.</p>
<p className="lead">We need your support to continue enhancing and maintaining the RECAP system. Please help us with a tax-deductible charitable donation today.</p>
