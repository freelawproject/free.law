...
<div className="row">
    ...
    <div className="col-xs-12 col-sm-4 col-md-3">
        <span className="pull-right"><a href="https://www.courtlistener.com/donate/?referrer=2019-big-button-recap" className="btn btn-lg btn-danger">Donate Now</a></span>
    </div>
</div>
...
<p><a href="https://www.courtlistener.com/donate/?referrer=2019-big-button-recap-2" className="btn btn-lg btn-danger">Donate Now</a></p>
