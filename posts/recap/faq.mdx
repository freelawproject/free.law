...
We currently support Firefox and Chrome. We have experimented with Opera, but found their extension store to be too buggy and restrictive to use productively. We are working on a version for Safari, and would love to add a version the Chromium-based IE Edge.
