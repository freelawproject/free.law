...
<div className="right-image">
    <a href="/images/taft.png">
        <img src="/images/taft-thumb.png"
             alt="A screenshot of President, Judge Taft"
             className="img-responsive border"/>
    </a>
    <p className="caption">President Taft's Biography Page</p>
</div>
...
<a href="https://www.courtlistener.com/api/bulk-info/#judge-data" className="btn btn-primary btn-lg">Read the Documentation</a>
