...
<div className="left-image">
    ...
    <p className="caption">The new navigation bar on every page.</p>
</div>
...
<div className="left-image">
    <img src="/images/adv-search-judges.png"
         alt="Screenshot of the Judge Advanced Search page"
         className="img-responsive border"/>
    <p className="caption">The new judicial advanced search page.</p>
</div>
<div className="clearfix"></div>
...
<div className="left-image">
    <img src="/images/cl-2010.png"
         alt="Screenshot of CourtListenter from 2010"
         className="img-responsive border"/>
    <p className="caption">CourtListener.com <a href="https://web.archive.org/web/20100328140211/http://courtlistener.com/">circa 2010</a> -- in the Beta days.</p>
</div>
<div className="clearfix"></div>
