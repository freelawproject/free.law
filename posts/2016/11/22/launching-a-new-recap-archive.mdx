...
<div className="left-image">
    <a href="https://www.courtlistener.com/recap/">
        <img src="/images/recap-adv-search.png"
             alt="RECAP Advanced Search Screen"
             className="img-responsive border"/>
    </a>
    <p className="caption">The new advanced search interface for the <a href="https://www.courtlistener.com/recap/">RECAP Archive</a>.</p>
</div>
