...
<div className="left-image">
    <a href="/pdf/18-Stat-204.pdf">
        <img src="/images/printing-approp.png"
                 alt="18 Stat. 204 (1874)"
                 className="img-responsive border"/>
    </a>
    <p className="caption">A snapshot of 18 Stat. 204 (1874), which allocated $25,000 to the Supreme Court for printing (<a href="https://www.wolframalpha.com/input/?i=25000+USD+in+1874+in+USD+today">about $557,100 today</a>).</p>
</div>
