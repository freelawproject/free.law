...
If you use PACER, consider installing the RECAP extension in your browser. If you are a researcher, you can search millions of federal filings in the <a href="https://www.courtlistener.com/recap/">RECAP Archive</a>. Journalists and court watchers will find <a href="https://www.courtlistener.com/help/alerts/#recap-alerts">docket alerts</a> and <a href="https://www.courtlistener.com/help/alerts/#search-alerts">RECAP search alerts</a> invaluable. If you get notifications from PACER, check out <a href="https://recap.email">our NEF notification handler</a>.
...
<div className="flex flex-wrap gap-6 justify-center">
    ...
    <span className="pt-4 hidden sm:inline">&nbsp;</span>
    <WhiteButton size="lg" href="https://wiki.free.law/c/courtlistener/help/api">Read about the RECAP APIs</WhiteButton>
</div>
<br/>
...
With RECAP search alerts, you’ll be notified whenever there's a new match in our PACER holdings for any search you make. You can follow topics, people, organizations, and more. You can create a number of alerts for free, and you get even more if you <a href="https://donate.free.law/forms/membership">become a member</a> of Free Law Project.

To save an alert, do a search and hit the bell icon next to your query. That’s it!

<div className="text-center">
  <WhiteButton size="lg" href="https://www.courtlistener.com/help/alerts/#search-alerts">Learn More About Search Alerts</WhiteButton>
</div>
<br/>
...
The RECAP Suite also has tools for techies, including:
 ...
 - [Webhooks](https://wiki.free.law/c/courtlistener/help/api/webhooks) so events on our website can trigger workflows in your systems.

 - An [API for purchasing PACER content](/2019/11/05/pacer-fetch-api/), so you don't have to scrape it yourself.

 - A tool for [finding bad redactions](/open-source-tools#/x-ray) in filings.

 - A [Python package](/open-source-tools#juriscraper) for pulling citations out of text.

 - A [microservice](/open-source-tools#/doctor) for extracting text from documents, including doing OCR.
...
[privacy]: https://wiki.free.law/c/terms/recap-extension/recap-extension-privacy-policy
[c]: /contact/
