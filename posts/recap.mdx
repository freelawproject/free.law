...
<div className="flex flex-wrap gap-6 justify-center">
    ...
    <span className="pt-4 hidden sm:inline">&nbsp;</span>
    <PurpleButton size="lg" href="https://www.courtlistener.com/help/api/">Read about the RECAP APIs</PurpleButton>
</div>
<br/>
...
<div className="text-center">
  <PurpleButton size="lg" href="https://www.courtlistener.com/help/alerts/">Learn More About Docket Alerts</PurpleButton>
</div>
<br/>
...
<div className="text-center">
  <PurpleButton size="lg" href="https://www.courtlistener.com/help/recap/email/">Learn More and Get Started</PurpleButton>
</div>
<br/>
