...
Current activities of Free Law Project are as follows:
 ...
 - We host the [RECAP Project][recap] including the [RECAP Archive][recap-archive] and the extensions for [Chrome][chrome], [Firefox][ff] and [Safari][safari]. This project frees millions of dockets, docket entries, and documents from PACER, making them searchable on CourtListener and uploading them to the Internet Archive for permanent backup.
...
[safari]: https://apps.apple.com/us/app/recap/id1600281788
