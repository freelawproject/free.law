...
<label for="mce-EMAIL" className="block">Email Address
    ...
    <input type="email" name="EMAIL" className="mt-1 block w-full" id="mce-EMAIL"/>
</label>

<label for="mce-FNAME" className="block">First Name
    <input type="text" name="Name" className="mt-1 block w-full" id="mce-FNAME"/>
</label>

<label for="mce-LNAME" className="block">Last Name
    <input type="text"name="Last Name" className="mt-1 block w-full" id="mce-LNAME"/>
</label>
