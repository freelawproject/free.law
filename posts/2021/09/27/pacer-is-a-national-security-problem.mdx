...
Unfortunately, today we are writing about a new reason. Today we are writing to share the ample evidence that the continued reliance on PACER and CM/ECF is a risk to Amercans' privacy and national security. In 2017, we discovered [a frighteningly basic vulnerability][vuln] in PACER that indicated there were likely larger problems in the system, but we were not ready to call it a threat to national security at the time. Now we are.
...
And finally, and, ironically in hindsight:
