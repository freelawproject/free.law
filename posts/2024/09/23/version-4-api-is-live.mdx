...
<p className="text-center">
  <PurpleButton href="https://www.courtlistener.com/help/api/v4/migration-guide/" size="lg">Learn More</PurpleButton>
</p>
...
[1]: https://www.courtlistener.com/help/api/v4/migration-guide/
