...
<p className="text-center">
  <PurpleButton href="https://www.courtlistener.com/help/api/rest/v4/migration-guide/" size="lg">Read the Guide</PurpleButton>
</p>
...
<p className="text-center">
  <PurpleButton href="https://www.courtlistener.com/help/api/rest/v4/migration-guide/" size="lg">Read the Migration Guide</PurpleButton>
</p>
