...
```txt
curl -X POST "https://wiki.free.law/c/courtlistener/help/api/rest/v4/citation-lookup" \
...
<p className="text-center">
  <PurpleButton href="https://wiki.free.law/c/courtlistener/help/api/rest/v4/citation-lookup" size="lg">Read the Documentation</PurpleButton>
</p>

[api]: https://wiki.free.law/c/courtlistener/help/api/rest/v4/citation-lookup
