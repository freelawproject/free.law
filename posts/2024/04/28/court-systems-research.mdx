...
<div class="text-center"><a class="text-center whitespace-nowrap border border-transparent rounded-md shadow-sm text-base font-medium text-white text-sm no-underline bg-purple-800 hover:bg-purple-900 inline-flex px-6 py-4 text-lg" href="/pdf/Problems-Court-Filing-CMS-Perspectives-from-Advocates-and-Vendors.pdf">Read the report</a></div>
