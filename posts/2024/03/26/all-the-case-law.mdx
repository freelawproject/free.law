...
<p className="lead">We began collecting case law in 2009, but before we entered the scene, there was already a goal shared among members of the community. That goal, put simply, was to be able to say, “It’s done. All the case law is now online.”</p>

One group that took a big swing at this audacious goal is the [Innovation Lab][lil] at Harvard Law Library, where they spent three years working with Ravel Law to [digitize][d] the library’s enormous collection of case law. That work was completed several years ago, but was not fully available until recently, when Harvard [released][r] the entire thing to the public. 
...
}} href="https://www.courtlistener.com/help/coverage/opinions/">A timeline showing the cases we have in the First Circuit of appeals.</CaptionedImage>

Today, we’re announcing our latest milestone. We have worked with the Harvard data for several years and have made [over a million enhancements to it][m]. All of this is now a part of [our case law collection][cl], bringing our total count to around nine million cases.

Working at this scale is tremendously challenging and time-consuming. The enhancements we have made include:

 - Analyzing every citation throughout American legal history so that it’s properly parsed and understood
 - Normalizing every court name so that it can be stored properly in a database
 - Using machine learning to improve and refine the data structure of millions of cases
 - Developing code to merge the best parts of our data with the best parts of Harvard’s

This work required a combination of legal research and technical knowhow. In the face of errors in the scanned books, we had to answer questions like “*Did this court even exist and if so, when?*” We had to grapple with technical questions like how to match a case from our existing data to one in the Harvard collection. We had to identify every possible way — correct or not — that somebody could make a citation to case law.

All of these challenges were solved in the open, providing vast public enhancements to [our database of courts][cts] and [our tool for identifying citations][eye]. All of [our corrections and enhancements][corr] to the data itself are online for others to use and build on.

## Into the Future

CourtListener is now one of the most comprehensive and transparent sources of case law, but there is always more work to do. In the coming months and years we will identify gaps that might exist between the conclusion of Harvard’s scanning effort and today. We will attempt a first-of-its-kind comparison between the data in for-profit systems vs. that of Harvard and CourtListener to learn how each can be enhanced. We will add more citations, better star pagination, and better typography. We will launch a project to scan books, so we can get content like citations and page numbers that are only available in books.

In 2024, we celebrate our 15th year collecting and disseminating case law. Through continued community effort and investment, our collection just gets better and better. No collection of case law is ever done, but by achieving digital equivalence with the Harvard Law Library, we’ve taken another huge step towards ensuring there’s no case law research that you can’t do either on CourtListener itself or in the ecosystem of organizations we empower.
