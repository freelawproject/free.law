...
date: "2019-11-05"
tags: ["PACER", "APIs"]
excerpt: Now you can use our APIs to scrape PACER. It doesn't get easier than this. 
---
...
<a href="https://www.courtlistener.com/api/rest-info/#pacer-fetch" target="_blank" className="btn btn-primary btn-lg">PACER Fetch Docs</a>
...
[vdp]: /vulnerabiltiy-disclosure-policy/
