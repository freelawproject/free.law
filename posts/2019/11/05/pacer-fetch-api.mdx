...
curl -X POST \
    ...
    https://wiki.free.law/c/courtlistener/help/api/rest/v4/recap#pacer-fetch
```
...
<PurpleButton size="lg" href="https://wiki.free.law/c/courtlistener/help/api/rest/#pacer-fetch" target="_blank">PACER Fetch Docs</PurpleButton>
...
[docs]: https://wiki.free.law/c/courtlistener/help/api/rest/#pacer-fetch
[js]: https://github.com/freelawproject/juriscraper
[recap]: https://www.courtlistener.com/recap/
[recap-ex]: https://free.law/recap/
[security]: https://wiki.free.law/c/courtlistener/help/api/rest/v4/recap#security-of-recap-fetch-api
