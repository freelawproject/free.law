...
1. You can forget about the notification emails you get from PACER. Instead, we'll start sending you emails with simple, reusable, sharable links to the documents.
