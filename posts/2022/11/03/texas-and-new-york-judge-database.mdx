...
Unlike most other judge databases, ours contains structured, machine-readable data. This makes it a treasure trove for researchers and data wonks. Rather than having paragraphs of biographical information about judges, our data is available via our <a href="https://www.courtlistener.com/api/">bulk data files and judge APIs</a>. You can use this data to research judges by positions they've held in public or private practice, where they went to school, who appointed them, and much more.
