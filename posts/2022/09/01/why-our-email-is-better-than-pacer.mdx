...
2. CourtListener alerts you via side channel if you have an issue. If we find that your email address no longer works, we pop up a huge banner in CourtListener and strongly encourage you to fix the issue. Once you fix it, we resend the things you missed (within reason).

On top of this, we carefully monitor our bounce notifications. This ensures that we don't send messages to inboxes that are truly dead, preventing CourtListener from getting marked as a spammer.
