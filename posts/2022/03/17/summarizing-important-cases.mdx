...
So that's how we did it, but no project like this happens in a vacuum. We could never have done this without the pioneering work of [Pablo Arredondo][pa] and [Casetext][ct] (where this idea was first researched and then put into action), the tireless energy of [Faiz Surani][f] and [Varun Iyer][v] at University of California, Santa Barbara, who did all the heavy lifting in this project, and the [Library Innovation Lab at Harvard][lil], with whom we collaborated on [eyecite][e].
