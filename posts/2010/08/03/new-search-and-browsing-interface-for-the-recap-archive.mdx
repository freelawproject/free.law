...
<p className="bg-danger alert"><strong>Update</strong>: We wound down this version of the archive, but we <a href="/2016/11/22/launching-a-new-recap-archive">replaced it with something <em>much</em> better</a>.</p>
