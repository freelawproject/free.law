...
excerpt: "Check out our new LibGuide for CourtListener resources!"
---
<p className="lead">We’re thrilled to introduce the [CourtListener LibGuide](https://free.law/librarians) — a brand-new resource built to help <strong>librarians, educators, researchers, and students</strong> unlock the full potential of CourtListener.</p>
...
<p>
<PurpleButton href="https://free.law/librarians" size="lg">Explore the CourtListener LibGuide Now
</PurpleButton>
</p>

Use Control + Shift + m to toggle the tab key moving focus. Alternatively, use esc then tab to move to the next interactive element on the page.
New File at posts/2025 · freelawproject/free.law
