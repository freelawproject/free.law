...
Eyecite is a high performance, robust, open source tool for extracting legal citations from text. It has been tested against more than fifty million citations, and is used, among other things, to annotate millions of legal documents in the collections of <Link href="/projects/courtlistener/"><a>CourtListener</a></Link> and the <a href="https://case.law">Caselaw Access Project</a>.
