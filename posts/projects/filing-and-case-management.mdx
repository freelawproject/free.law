---
title: Filing and Case Management System Research
type: page
---

<p className="lead">We are researching and planning the next generation of open court filing and case management systems.</p>

## Blog posts and reports

You can keep up with this project on our blog:

- [Report on our interviews with advocates and vendors][advocate-report]
- [Project launch announcement][launch-blog]

[advocate-report]: /2023/12/12/open-efiling-launch/
[launch-blog]: /2024/04/29/court-systems-research/

## Existing state contracts for related systems

In our early research, we requested procurement documents for current and past filing and case management systems from the 5 most populous states. 
