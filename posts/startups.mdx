...
Accessing the data can be done in one of three ways:
 ...
 - **Bulk Data** — Many of our objects are available as bulk data. This is great for MVPs, prototyping, etc, but is only updated quarterly, and takes a fair bit of work to get into a database.
...
[api-home]: https://wiki.free.law/c/courtlistener/help/api
...
When we work with for-profit organizations, we generally set up a licensing agreement for payment. Payments are priced based on means and mission — how much you can pay and how much your mission aligns with ours. Prices start at free and go up from there, with [memberships][mem] being an option for many. It can really depend, but we always try to find a place that works for everybody we talk to.
...
Sometimes, but that's not our goal. Our goal is to provide base layer software and data that every system might need. By doing this, we dogfood the data, and we learn first-hand how to improve it. 
