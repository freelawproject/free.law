...
We have two strategies to do this. First, we establish a foundational layer of legal data and technology that can benefit every American. Second, we share our work with other organizations so that the success of those organizations can be a force multiplier for our mission.
...
We provide the following types of data:
 ...
 - **Oral Argument Data** — We have the largest collection of oral argument audio files and transcripts on the Internet. We have been collecting this data for a decade, but it has not been useful until recently, when AI made accurate transcripts possible. We expect more innovation with this data. [Learn more here][oa].
...
1. We don't believe data is a reliable moat. Instead of relying on exclusive access to public domain data, build a moat with your expertise, innovative technology, marketing, reputation, sales, and business practices. If that's not enough, you're in trouble.

2. We have so much data, your small addition to it probably won't be noticed by anybody, and we take the secrecy of whom we work with as a top priority. 
...
From time to time, our systems will take a startup 90% of the way to what they need, but there's some feature or data that isn't quite good enough. 
...
We don't usually do either, but we're getting to the point where it could make sense. We have to be careful though, as a non-profit.
