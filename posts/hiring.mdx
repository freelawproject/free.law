...
None, sorry! If you really want to work with us though, three suggestions:

1. You can get engaged as a volunteer or just hang out in our Slack. Generally, if we know who you are, you've got a leg up when we next hire.

2. You can follow our [twitter account](https://twitter.com/freelawproject), where we'll announce openings in the future.

3. You can send in your application anyway, but it's a real long shot to get on our radar by doing so (sorry, it's true; we mostly ignore resumes when we're not hiring).
