...
<p className="lead">We are not currently hiring, sorry!</p>

<p className="pt-5">
    <PurpleButton href="https://donate.free.law/np/clients/freelawproject/subscribe.jsp?subscription=17" size="lg" extraClasses="inline-flex"><CheckIcon className="flex-shrink-0 h-7 w-7 pr-1"/> Sign Up for Updates</PurpleButton>
</p>
...
## Product Manager / User Researcher (Full Time / Remote)
